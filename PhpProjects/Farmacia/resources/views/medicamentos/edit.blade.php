...
@section('content')
    <div class="container">
        ...
        @endif
        <form action="{{ route('medicamentos.update', $mendicamento->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="number" name="fabricante" class="form-control" value="{{ $produto->fabricante }}">
            </div>
            <div class="form-group">
                <label for="data_validade">Data de validade:</label>
                <input type="number" name="data_validade" class="form-control" value="{{ $produto->data_validade }}">
            </div>
            <div class="form-group">
