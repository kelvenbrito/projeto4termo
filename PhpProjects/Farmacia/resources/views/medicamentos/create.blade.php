    ...
    <div class="container">
        ...
        <form action="{{ route('medicamentos.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="number" name="fabricante" class="form-control" placeholder="Fabricante">
            </div>
            <div class="form-group">
                <label for="data_validade">Data de validade:</label>
                <input type="number" name="data_validade" class="form-control" placeholder="Validade">
            </div>
            <div class="form-group">
